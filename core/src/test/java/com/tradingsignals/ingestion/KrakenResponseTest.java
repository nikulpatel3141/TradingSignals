...
class KrakenResponseTest {
    ...
    public void testSnapshotParsing() throws JsonProcessingException {
        var result = KrakenResponse.parseMessage(SNAPSHOT_RESPONSE);
    ...
    public void testUpdateParsing() throws JsonProcessingException {
        var result = KrakenResponse.parseMessage(UPDATE_RESPONSE);
        ...
        assertEquals(Instant.parse("2025-09-30T13:36:20.775204Z"), data.timestamp());
